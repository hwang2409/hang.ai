# What Makes a Notes App the God of Productivity / Study Help

A great notes app is not just a place to store text. It acts as a **second brain, tutor, memory system, and execution layer**. The key difference is that it should be **active, not passive**.

## Core Idea
Most notes apps only store information. The best one should help users:
- capture
- understand
- organize
- recall
...
**Drop in messy notes, PDFs, and recordings — get summaries, flashcards, quizzes, explanations, and a personalized study plan.**

---

## Features — Sorted by Importance

> ✅ = implemented &nbsp; ⬜ = not yet &nbsp; 🟡 = partially done

---

### 1. Clean UX (Foundation — Everything Depends on This)

| Feature | Status |
|---------|--------|
| Fast, minimal interface | ✅ |
| Low-friction editing with auto-save | ✅ |
| Keyboard-friendly (Cmd+K search, Cmd+E mode toggle, Cmd+J vim) | ✅ |
| Dark/light mode | ✅ |
...
### 2. Frictionless Capture (Pillar 1 — Getting Stuff In)

| Feature | Status |
|---------|--------|
| Text notes (markdown) | ✅ |
| Canvas / diagrams (Excalidraw) | ✅ |
| Moodboards (visual/image grids) | ✅ |
| PDF upload + viewer | ✅ |
| Image upload + viewer | ✅ |
| Video upload + player | ✅ |
| Audio file upload | ✅ |
...
### 3. Automatic Understanding (Pillar 2 — The App Thinks For You)

| Feature | Status |
|---------|--------|
| Auto-extract key concepts from notes | ✅ (insights tab) |
| Auto-detect definitions | ✅ (insights tab) |
| Auto-detect formulas/equations | ✅ (insights tab) |
...
### 4. Note Transformation (Pillar 3 — Messy Notes → Study Assets)

| Feature | Status |
|---------|--------|
| AI-generated summaries | ✅ (chat + selection actions) |
...
| Active recall via flashcard study | ✅ |
| Weak-area detection (low ease scores) | ✅ |
...
| Feature | Status |
|---------|--------|
| Explain concepts simply (AI chat) | ✅ |
| Define difficult terms (selection action) | ✅ |
...
### 7. Knowledge Connections (Link Ideas Across Notes)
...
### 8. Smart Search (Find by Meaning)
...
| Feature | Status |
|---------|--------|
| Todo list with priorities + due dates | ✅ |
| Pomodoro timer with session tracking | ✅ |
| AI study plans with checklist | ✅ |
